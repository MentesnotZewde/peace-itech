    ...
    <PageShell className="flex items-center justify-center p-4">
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden shadow-xl bg-card">
        ...
        <div className="flex flex-col justify-center px-8 py-12 sm:px-20">
          <div className="flex items-center gap-2 mb-10">
            <Image
              ...
              className="h-8 w-8"
            />
            <span className="font-semibold text-lg">Peace iTech</span>
          </div>
        ...
        <div className="relative hidden lg:block bg-neutral-950">
          ...
          <div className="absolute bottom-10 left-0 right-0 px-10 text-center text-white">
            <h2 className="text-2xl font-bold">Build Better, Ship Faster</h2>
            <p className="mt-2 text-sm text-neutral-300">
              Manage your projects, teams, and systems from anywhere, on any
              device.
            </p>
