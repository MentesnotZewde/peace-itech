    ...
    <section className="relative isolate overflow-hidden bg-background py-16 transition-colors sm:py-20 lg:py-24">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-6 text-base leading-7 text-muted-foreground sm:text-md sm:leading-8">
        ...
        <div className="mx-auto grid max-w-sm gap-5 md:max-w-none md:grid-cols-2 lg:grid-cols-3 lg:gap-6">
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="mt-5">
                <span className="text-3xl font-serif text-foreground sm:text-4xl">
                  {plan.price}
                </span>
              ...
              <ul className="mt-5 space-y-2.5">
                {plan.features.map((feature) => (
                  ...
                  >
                    <Check size={16} className="text-sky-500 mt-1 shrink-0" />
